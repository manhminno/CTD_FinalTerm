...
struct {
  ...
  {"CASE", KW_CASE},            // TODO:2
  {"DEFAULT", KW_DEFAULT},      // TODO:2
  {"BREAK", KW_BREAK}           // TODO:2
};
...
char *tokenToString(TokenType tokenType) {
  switch (tokenType) {
    ...
    case KW_CASE: return "keyword CASE";        // TODO:2
    case KW_DEFAULT: return "keyword DEFAULT";  // TODO:2
    case KW_BREAK: return "keyword BREAK";      // TODO:2
