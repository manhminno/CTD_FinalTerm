...
int emitEXP(CodeBlock* codeBlock) { return emitCode(codeBlock, OP_EXP, DC_VALUE, DC_VALUE); }     // TODO:1
...
void printInstruction(Instruction* inst) {
  switch (inst->op) {
    ...
    case OP_EXP: printf("EXP"); break;            // TODO:1
...
void sprintInstruction(char* s, Instruction* inst) {
  ...
  case OP_EXP: sprintf(s,"EXP"); break;             // TODO:1
